    ...
    this.initState.prototype = {
        create: function () {
            ...
            this.tiger = _game.createAtlasObject.apply(this, [[
                {
                    image: this.getTextureAtlas("bt_trai_1"),
                    animation: false
                }, {
                    image: this.getTextureAtlas("bt_phai"),
                    animation: false
                }, {
                    image: this.getTextureAtlas("bt_than"),
                    animation: false
                }, {
                    image: this.getTextureAtlas("bt_trai"),
                    animation: false
                }, {
                    image:  this.getTextureAtlas("bt_dau"),
                    animation: true
                }
            ]]);
            this.tiger.x = 165;
            this.tiger.y = _game.hh + 100;
            this.game.add.tween(this.tiger).to({y: _game.hh + 120}, 400, Phaser.Easing.Back.Out, true);
